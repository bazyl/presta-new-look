...
{/if}
<p class="clear"><a href="{$base_dir_ssl}my-account.php" title="{l s='Back to Your Account'}"><img src="{$img_dir}icon/my-account.gif" alt="{l s='Your Account'}" class="icon" /></a><a href="{$base_dir_ssl}my-account.php" title="{l s='Back to Your Account'}">{l s='Back to Your Account'}</a></p>
