...
{else}
	{if !isset($email_create)}
		<form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="create-account_form" class="std">
			<fieldset>
				...
				<p><input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large" value="{l s='Create your account'}" /><input type="hidden" name="SubmitCreate" value="{l s='Create your account'}" /></p>
			</fieldset>
		</form>
	...
	{else}
	<form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="account-creation_form" class="std">
