...
<div>
	...
	<p>{l s='We remind you that your package must be returned to us within 7 days of initially receiving your order.'}</p>
...
<div>
	...
	<br /><br /><a href="{$base_dir}contact-form.php">{l s='Let us know if you have any questions.'}</a>
	<br />
