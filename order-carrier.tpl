...
{if $conditions}
	...
	<p class="checkbox">
		...
		<label for="cgv">{l s='I agree with the terms of service and I adhere to them unconditionally.'}</label> <a href="{$base_dir}conditions.php?width=450&amp;height=500&amp;thickbox=true" class="thickbox">{l s='(read)'}</a>
	</p>
{/if}

{if $virtual_cart}
	<input id="input_virtual_carrier" type="hidden" name="id_carrier" value="0" />
{else}
