...
{else}
	...
	<p>{if $manufacturers|@count > 1}{l s='There are'} <span class="bold">{$manufacturers|@count} {l s='manufacturers.'}</span>{else}{l s='There is'} <span class="bold">{$manufacturers|@count} {l s='manufacturer.'}</span>{/if}</p>
